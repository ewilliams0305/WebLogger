...
```
Note when pulled in with Nuget the OutputItemType="Analyzer" is already configured for you.  After adding the package the `CommandHandlerAttribute` will be generated and added to your project in the CommandHandlerAttribute.g.cs file.
